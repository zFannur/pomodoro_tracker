...
Таймер по технике Pomodoro с точной моделью серий, простоев и фокуса — плюс
система фокуса (лягушка дня, задачи спринта, Flowtime) и все данные в обычных
`.md`-файлах внутри Obsidian-валта.
...
[![Tests](https://img.shields.io/badge/tests-27%20passing-3FA45B.svg)](#тесты)
